...
\frame{
  ...
  \item Read and present state-of-the-art reseach papers
  \end{itemize}
}
...
\frame{
  ...
  \item These can be announced or un-announced (surprize quizzes).
  \item Always bring a pen and some loose papers to the class
  \end{itemize}
}
...
\frame{
  ...
  \begin{itemize}
  \item What are the vaious phases of a typical compiler? (5 minutes)
...
\frame{
  \frametitle{Common Subexpresion Elimination}
  \psset{unit=1mm}
...
\frame{
  ...
  \item Replace divison by right shift
  \end{itemize}
}
